...
[1-hbtn_header.py](./1-hbtn_header.py) | Python script that accepts a URL, sends a request to the URL and displays the value of the X-Request-Id variable found in the header of the response
